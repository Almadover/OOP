...
class Lecturer(Mentor):
    ...
    def middle_rating(self):
        ...
        for course_grades in self.rates.values():
            ...
            for grade in course_grades:
                course_sum += grade
            middle_on_courses = course_sum/len(course_grades)
            middle_sum += middle_on_courses
        if middle_sum == 0:
            return f'Нет оценок'
        else:
            return f'{middle_sum/len(self.rates.values())}'
        
    def __str__(self):
        res = f'Имя: {self.name} \nФамилия: {self.surname} \n'
        res += f'Средняя оценка за лекции: {self.middle_rating()} \n'
        return res
    ...
    def __lt__(self, lecturer):
        if not isinstance(lecturer, Lecturer):
            ...
            return
        return self.middle_rating() < lecturer.middle_rating()
...
reviewer_1.rate_student(student_1, 'Git', 10)
reviewer_1.rate_student(student_1, 'Java', 5)
reviewer_1.rate_student(student_1, 'Java', 8)
reviewer_1.rate_student(student_1, 'Java', 9)
reviewer_1.rate_student(student_1, 'Python', 9)
reviewer_1.rate_student(student_1, 'Python', 3)
reviewer_1.rate_student(student_1, 'Python', 2)
reviewer_1.rate_student(student_1, 'С++', 10)
reviewer_1.rate_student(student_1, 'С++', 9)
reviewer_1.rate_student(student_1, 'С++', 4)

reviewer_2.rate_student(student_2, 'С++', 4)
reviewer_2.rate_student(student_2, 'С++', 2)
reviewer_2.rate_student(student_2, 'С++', 3)
reviewer_2.rate_student(student_2, 'Git', 8)
reviewer_2.rate_student(student_2, 'Git', 1)
reviewer_2.rate_student(student_2, 'Git', 7)
reviewer_2.rate_student(student_2, 'Python', 8)
...
reviewer_2.rate_student(student_2, 'Java', 4)
